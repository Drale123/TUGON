    ...
    <div class="row mt-4">
        ...
        <div class="col-md-9 mx-auto">
            <div class="container my-4">
                <h1 class="title">Extreme Heat Preparedness</h1>
                
                <div class="mb-4">
                <img src="assets/img/extreme_heat/extreme_heat.jpg" alt="Stay Safe After Earthquake" class="img-fluid rounded mb-3">
