    ...
    <div class="row mt-4">
        ...
        <div class="col-md-9 mx-auto">
            <div class="container my-4">
                <h1 class="title">Typhoon Preparedness</h1>
                
                <div class="mb-4">
                <img src="assets/img/typhoon/typhoon.jpg" alt="Stay Safe After Earthquake" class="img-fluid rounded mb-3">
                    In the Philippines, where typhoons frequently strike with devastating force, being prepared for these natural disasters is of paramount importance. With an average of 20 typhoons entering the country each year, Filipinos must equip themselves with the knowledge and resources to safeguard their lives, families, and properties. While the government addresses
                    underlying issues that are exacerbated by climate change, such as deforestation and urban planning, individual preparedness remains a crucial aspect of typhoon survival.
